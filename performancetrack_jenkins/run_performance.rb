...
start_num_threads = 2#(ENV["Start_Num_Threads"] == "Default" || ENV["Start_Num_Threads"] == nil) ? nil : ENV["Start_Num_Threads"].to_i
increase_step = 2#(ENV["Increase_Step"] == "Default" || ENV["Increase_Step"] == nil) ? nil : ENV["Increase_Step"].to_i
target_num_threads = 2#(ENV["Target_Num_Threads"] == "Default" || ENV["Target_Num_Threads"] == nil) ? nil : ENV["Target_Num_Threads"].to_i
test_plan_template = (ENV["Test_Plan"] == nil || ENV["Test_Plan"] == "") ? nil : ENV["Test_Plan"]
loops = 10#ENV["Loops"] == "Default" ? nil : ENV["Loops"].to_i
duration = nil#ENV["Duration"] == "Default" ? nil : ENV["Duration"]
warmup_period = 0#ENV["Warmup_Period"] == "Default" ? nil : ENV["Warmup_Period"]
...
puts "Parameters:"
puts "-------------------------------"
puts "Threads: #{start_num_threads}"
