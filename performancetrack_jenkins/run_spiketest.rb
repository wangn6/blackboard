...
#start_num_threads = (ENV["Start_Num_Threads"] == "Default" || ENV["Start_Num_Threads"] == nil) ? nil : ENV["Start_Num_Threads"].to_i
#increase_step = (ENV["Increase_Step"] == "Default" || ENV["Increase_Step"] == nil) ? nil : ENV["Increase_Step"].to_i
target_num_threads = (ENV["Target_Num_Threads"] == "Default" || ENV["Target_Num_Threads"] == nil) ? nil : ENV["Target_Num_Threads"].to_i
start_num_threads = target_num_threads
increase_step = 2
...
test_detailed_info = {
	'parameters'=>{
		'Target Threads' => start_num_threads,
